    ...
    >
      ...
      <div className="mx-auto max-w-3xl px-3 py-2 sm:px-4">
        ...
        <div className="mt-1.5 flex gap-1.5">
          ...
          <button type="button" onClick={paused ? resumeRestTimer : pauseRestTimer} className={controlClass}>
          ...
          <button type="button" onClick={skipRestTimer} className={controlClass}>
