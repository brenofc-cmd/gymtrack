...
export const DAVID_LAID_EXERCISE_CATALOG_V5 = {
  ...
  'walking-lunge': exercise('walking-lunge', 'Afundo caminhando', 'Walking lunge', 'composto', 'quadríceps', ['glúteos', 'adutores'], 'unilateral_leg', 'halteres', 'dumbbell_each_kg', '/exercises/Dumbbell_Lunges.jpg', { unilateral: true, incrementKg: 1 }),
  ...
  'reverse-hyper': exercise('reverse-hyper', 'Reverse hyper', 'Reverse hyperextension', 'isolador', 'glúteos', ['isquiotibiais', 'eretores da coluna'], 'hip_extension', 'máquina reverse hyper', 'added_load_kg', '/exercises/Reverse_Hyperextension.jpg'),
  ...
  'dumbbell-triceps-extension': exercise('dumbbell-triceps-extension', 'Extensão de tríceps com halter', 'Dumbbell triceps extension', 'isolador', 'tríceps', [], 'elbow_extension', 'halter', 'added_load_kg', '/exercises/Standing_Dumbbell_Triceps_Extension.jpg'),
  'conventional-deadlift': exercise('conventional-deadlift', 'Levantamento terra convencional', 'Conventional deadlift', 'composto', 'cadeia posterior', ['glúteos', 'isquiotibiais', 'costas', 'core'], 'hip_hinge', 'barra', 'barbell_total_kg', '/exercises/Barbell_Deadlift.jpg', { incrementKg: 2.5, warnings: ['Interrompa com dor ou perda importante da posição lombar.'] }),
  'stiff-leg-deadlift': exercise('stiff-leg-deadlift', 'Stiff-leg deadlift', 'Stiff-leg deadlift', 'composto', 'isquiotibiais', ['glúteos', 'eretores da coluna'], 'hip_hinge', 'barra', 'barbell_total_kg', '/exercises/Stiff-Legged_Barbell_Deadlift.jpg'),
  'deficit-stiff-leg-deadlift': exercise('deficit-stiff-leg-deadlift', 'Stiff-leg deadlift em déficit', 'Deficit stiff-leg deadlift', 'composto', 'isquiotibiais', ['glúteos', 'eretores da coluna'], 'hip_hinge', 'barra e plataforma de 5–7,5 cm', 'barbell_total_kg', '/exercises/Romanian_Deadlift_from_Deficit.jpg'),
  'pull-up': exercise('pull-up', 'Barra fixa', 'Pull-up', 'composto', 'costas', ['bíceps', 'antebraços'], 'vertical_pull', 'barra fixa, cinto ou assistência', 'bodyweight_or_assistance_kg', '/exercises/Pullups.jpg', { incrementKg: 1 }),
