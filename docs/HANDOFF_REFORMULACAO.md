...
> **Registro histórico (pré-auditoria).** Números, contagens de testes e
> pendências citados aqui refletem o estado da época e foram superados pelas
> rodadas seguintes — ver `docs/RELATORIO_AUDITORIA.md` e
> `docs/RELATORIO_CORRECOES_FINAIS.md` para o estado atual.
